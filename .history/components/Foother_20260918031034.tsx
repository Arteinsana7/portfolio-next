...
const Footer = () => {
  return (
    ...
    <footer className="w-full pt-20 pb-20 relative" id="contact">
      {/* Fondu en bas */}
      <div className="absolute left-0 right-0 -top-40 bottom-0 pointer-events-none">
        +        <HoloBackground />
        +      </div>
      <div className="absolute left-0 right-0 -top-40 h-40 pointer-events-none z-[1] bg-gradient-to-b from-transparent to-black-100" />
      ...
      +      <div className="flex flex-col items-center relative z-10">        <h1 className="heading lg:max-w-[45vw]">
