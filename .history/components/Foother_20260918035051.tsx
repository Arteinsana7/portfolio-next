    ...
    <footer className="w-full pt-20 pb-20 relative " id="contact">
      ...
      <div className="flex flex-col items-center p-4  relative z-10">
        <h1 className="heading lg:max-w-[45vw] p-1">
          Discutons de la manière dont nous pouvons
          <span className="text-purple">Collaborer</span>
        </h1>
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center relative z-10">
        <p className="md:text-base text-sm md:font-normal font-light px-10">
          ...
          Build with Next.js © 2024 Eliana Yepez - updated 2026. All rights reserved.
        </p>
      </div>
