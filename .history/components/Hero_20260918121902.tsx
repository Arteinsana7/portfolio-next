...
const Hero = () => {
  return (
    <div className="pb-20 pt-36 overflow-hidden relative min-h-screen">
      <HoloBackground />
      {/* Background Gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black-100 z-[0
  ...
  absolute top-0 left-0  flex items-center justify-center"
   ...
   [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[50vw] lg:min-h-[60vh] flex flex-col items-center justify-center">
          ...
          <TextGenerateEffect
            words="Bonjour je suis Eliana, Designeuse digitale et Développeuse créative"
