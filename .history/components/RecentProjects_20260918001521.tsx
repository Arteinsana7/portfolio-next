          ...
          >
            ...
            >
              <div className="flex flex-col h-[28rem] w-full">
                ...
                <div className="relative sm:w-96 w-[80vw] h-[15rem] overflow-hidden rounded-3xl mb-4 p-2">
                  <div
                  ...
                  {item.video ? (
                    <video
                      ...
                      loop
                      playsInline
                      className="z-10 absolute inset-2 w-[calc(100%-1rem)] h-[calc(100%-1rem)] object-cover rounded-2xl"
                    />
                  ) : (
                    <img
                      src={item.img}
