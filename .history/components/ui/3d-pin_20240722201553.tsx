...
export const PinContainer = ({
  ...
  return (
    ...
    >
      <Link
        href={href || "/"}
        target={href ? "_blank" : undefined}  // Add target blank for external links
        rel={href ? "noopener noreferrer" : undefined}  // Add rel for external links
        passHref
      >
        <div
          style={{
