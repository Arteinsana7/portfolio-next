  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundImage:
          'linear-gradient(90deg, rgba(41,5,83,1) 1%, rgba(20,113,172,1) 54%, rgba(0,212,255,1) 100%)',
      }}
    >
      <div className={id === 6 ? 'flex justify-center h-full' : ''}>
        ...
        <div
          className={cn(
            titleClassName,
            'group-hover/bento:transition duration-200 relative md:h-full min-h-40 flex flex-col px-5 p-5 lg:p-10'
          )}
        >
        ...
        {id === 2 && <GlobeDemo />}
        {id === 3 && (
          <div className="flex gap-1 lg:gap-5-fit absolute -right-2">
