...
export const BentoGridItem = ({
  ...
  const leftLists = ["HTML", "CSS","JavaScript","React", "Next"];
  const rightLists = ["Node","Spring", "Express", "MySQL"];
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {/* remove mb-2 mt-2 */}
          <div
            className={`font-sans text-lg lg:text-3xl max-w-96 font-medium z-10`}
          >
            {title}
          </div>
