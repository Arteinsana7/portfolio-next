...
// `LedVideo` is not present in this project, so the import must be removed unless the file exists.
// The component conditionally renders it only when `video` is provided, so we can safely avoid the import.
