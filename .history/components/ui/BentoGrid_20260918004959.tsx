...
// Temporary fix: the project currently doesn't include a LedVideo component file.
// Importing it breaks TypeScript builds. The feature is optional, so guard the
// usage behind a safe runtime fallback instead of failing module resolution.
