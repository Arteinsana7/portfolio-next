export const navItems = [
  ...
  export const gridItems = [
    ...
    },
    {
      id: 3,
      title: "Mes Stacks",
      description: "Évolution & apprentissage constante",
      className: "lg:col-span-2 md:col-span-3 md:row-span-2",
      imgClassName: "",
    ...
    {
      id: 4,
      title: "Riche d'expérience dans le marketing & communication digitale",
      description: "Analyse de donées & stratégie",
    ...
    {
      id: 5,
      title: "Formée chez Ada Tech School",
  ...
  export const projects = [
    ...
    {
      id: 2,
      title: "Squisse. Applicationb mobile Android",
    ...
    {
      id: 3,
      title: "OnMeuble. Site e-commerce",
      des: "Création d'une API. Conexion. Operations CRUD ",
      img: "/OnMeuble.png",
    ...
    {
      id: 4,
      title: "Zappel-Phillip. Application mobile iOS",
    ...
    },
    {
      ...
      img: "/daily.png",
      iconLists: ["/file-type-js-official.svg","/file-type-xcode.svg"],
      link: "https://github.com/Arteinsana7/Zappel-Philipp",
    },
  ];
