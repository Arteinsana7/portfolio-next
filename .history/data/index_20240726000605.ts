  ...
  export const workExperience = [
    {
      ...
      desc: "Gestion de projet événementielle et mise en avant des produits via les réseaux sociaux et newsletters.  Concevoir, exécuter et analyser des campagnes publicitaires sur les réseaux sociaux, moteurs de recherche et autres plateformes numériques.",
