  ...
  export const workExperience = [
    {
      ...
      desc: "création et la mise en œuvre de stratégies pour promouvoir la marque à travers des canaux numériques, gérer les campagnes en ligne, et analyser les résultats. En parallèle, il/elle organise et coordonne des événements, développe des stratégies de communication spécifiques, gère les relations avec les partenaires et fournisseurs, et évalue le succès des événements pour optimiser les futurs projets.",
