  ...
  export const workExperience = [
    {
      ...
      desc: "j'ai créé et mis en œuvre des stratégies pour promouvoir la marque à travers divers canaux numériques, tout en gérant les campagnes en ligne et en analysant les résultats. J'ai également organisé et coordonné des événements, développé des stratégies de communication spécifiques, et géré les relations avec les partenaires et fournisseurs. J'ai évalué le succès des événements pour optimiser les projets futurs.",
